...
function App() {
  ...
  return (
    <>
     <input onChange={(e) => setCity(e.target.value)} value={city} class="input" name="text" placeholder="Search country..." type="search"></input>
      {weather.status == "sucsess" && <div class="cardContainer">
        <div class="card">
          <p class="city">{weather.weather.name} </p>
          <p class="weather">{weather.weather.weather[0].description}</p>
          <svg
            class="weather"
            version="1.1"
            id="Layer_1"
          ...
          <p class="temp">{(weather.weather.main.temp - 273.0).toFixed(0)}°</p>
          <div class="minmaxContainer">
            <div class="min">
              <p class="minHeading">Min</p>
              <p class="minTemp">{(weather.weather.main.temp_min - 273.0).toFixed(0)}°</p>
            </div>
            <div class="max">
              <p class="maxHeading">Max</p>
              <p class="maxTemp">{(weather.weather.main.temp_max - 273.0).toFixed(0)}°</p>
            </div>
          </div>
        </div>
      </div>}
